...
import com.bloodreaper.lostandfound.main.lost.LostFragmentDirections
...
import com.bloodreaper.lostandfound.viewmodel.FoundPostViewModel
import kotlinx.coroutines.ExperimentalCoroutinesApi

class FoundFragment : Fragment() {
    private val viewModel: FoundPostViewModel by viewModels()
            ...
            setContent {
                LazyListTheme {
                    Column(modifier = androidx.compose.ui.Modifier.padding(8.dp).fillMaxWidth()) {
                        TopAppBar(
                            title = {
                                Text(text = "Reported Found Items")
                            },
...
//                        contentColor = Color.White
                ...
                Box(
                    ...
                    FloatingActionButton(
                        ...
                        onClick = {
                            findNavController().navigate(FoundFragmentDirections.actionFoundFragmentToPostForFoundItemFragment())
                        }
                    ) {
                        Icon(
                            Icons.Filled.Add,
    ...
    @Composable
    fun SetData(viewModel: FoundPostViewModel) {
